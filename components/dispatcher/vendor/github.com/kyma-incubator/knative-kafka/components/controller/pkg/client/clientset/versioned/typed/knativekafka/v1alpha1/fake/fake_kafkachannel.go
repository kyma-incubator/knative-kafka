...
type FakeKafkaChannels struct {
	Fake *FakeKnativekafkaV1alpha1
	ns   string
}

var kafkachannelsResource = schema.GroupVersionResource{Group: "knativekafka.kyma-project.io", Version: "v1alpha1", Resource: "kafkachannels"}

var kafkachannelsKind = schema.GroupVersionKind{Group: "knativekafka.kyma-project.io", Version: "v1alpha1", Kind: "KafkaChannel"}
