...
import (
	...
	internalinterfaces "github.com/kyma-incubator/knative-kafka/components/controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kyma-incubator/knative-kafka/components/controller/pkg/client/listers/knativekafka/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KnativekafkaV1alpha1().KafkaChannels(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KnativekafkaV1alpha1().KafkaChannels(namespace).Watch(options)
			},
		},
		&knativekafkav1alpha1.KafkaChannel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaChannelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&knativekafkav1alpha1.KafkaChannel{}, f.defaultInformer)
}
