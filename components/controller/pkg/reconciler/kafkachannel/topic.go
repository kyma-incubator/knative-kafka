...
func (r *Reconciler) reconcileTopic(ctx context.Context, channel *kafkav1alpha1.KafkaChannel) error {
	...
	// If The Channel Is Being Deleted
	if channel.DeletionTimestamp != nil {

		// TODO - This is the preliminary implementation which is straightforward so that we can make progress and is easier to work with for day to day development.
		// TODO - Need to define requirements around whether / how to delete topics.
		// TODO - This is a non-recoverable destruction of all data in the topic and not likely something we should do when a Channel CRD is deleted!!!

		// Then Remove The Topic (Handles Case Where Doesn't Exist)
